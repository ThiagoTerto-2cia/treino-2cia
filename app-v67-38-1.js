...
/* ===== V67.38.1 — FEED ESPORTIVO DA 2ª CIA ===== */
...
window.addEventListener('online',()=>{if(cloudSession?.token){v6738FlushFeedPending();if(document.querySelector('.view.active')?.id==='home')v6738LoadFeed(true)}});
