...
function renderCoreOperational(){
  ...
  box.innerHTML=`
    <div class="core-op-hero">
      ...
      <button type="button" class="core-atlas-btn" onclick="openCoreVisual('assets/core-operacional/core_operacional_25_exercicios-guia.webp','Atlas visual — Core Operacional')">🗂️ VER ATLAS VISUAL DO CORE</button>
    </div>
...
localStorage.setItem('t2_app_version','v67.5');
