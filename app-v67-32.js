...
localStorage.setItem('t2_app_version','v67.32');
...
function serviceCaptureDirectEntry(){
  try{
    ...
    // V67.32 — se o militar já escolheu/validou e apenas atualizou a página,
...
async function serviceDirectValidate(){
  ...
  try{
    // V67.32 — uma validação já ativa nunca é renovada por uma nova leitura do QR.
...
try{localStorage.setItem('t2_app_version','v67.32')}catch(e){}
