...
async function v55LoadRanking(){
 ...
 try{
   ...
   const rows=isAnnual
     ...
     : await v55RpcAll('ranking_constancia',{p_token_militar:cloudSession.token,p_mes:v55MonthKey(now)});
   ...
   box.innerHTML=`${v55RankingTabs()}<div class="v55-rank-title"><small>2ª CIA / 4º BBM</small><h2>Ranking de Frequência</h2><p>${periodLabel}</p></div>
...
try{localStorage.setItem('t2_app_version','v67.14')}catch(e){}
