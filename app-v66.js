...
function saveFreeWorkout(){
  ...
  const record={
    ...
    schemaVersion:66,excludedFromStats:false,workoutType:'free',muscleGroups:groups,
  ...
  alert(`Treino livre salvo.\n${groups.join(', ')} • ${minutes} min\n${record.serviceDay?'Dia de serviço — elegível ao ranking conforme regra.':'Fora de serviço — não conta no ranking.'}`);
  openWorkoutChooser();
}
...
localStorage.setItem('t2_app_version','v66.0');
...
async function v55LoadRanking(){
 ...
 <div class="card v55-rank-explain"><h3>Como funciona a pontuação?</h3><p><b>Cada treino válido soma 1 ponto de constância.</b> <b>Somente treinos realizados em dia de serviço entram no ranking.</b> Nos treinos prontos e personalizados, é necessário registrar pelo menos <b>3 exercícios e 6 séries</b>. No treino livre, é necessário informar grupo muscular e registrar pelo menos <b>20 minutos</b> de treino. Treinos realizados fora do serviço continuam salvos normalmente, mas não pontuam. Carga e peso levantado não aumentam a pontuação.</p></div>`+
 ...
 '<p class="v55-note">O ranking mede a constância nos dias de serviço, não força. Cargas individuais não são exibidas.</p>';
