...
const MOBILITY_ROUTINES={
  ...
  ankles:{
    title:'Tornozelos',
    icon:'◜',
    subtitle:'Mobilidade e estabilidade de tornozelos',
    duration:'5 min',
    steps:[
      {name:'Círculos de tornozelo',time:40,detail:'Eleve levemente o pé e faça círculos lentos do tornozelo nas duas direções.'},
      {name:'Joelho à parede',time:50,detail:'Projete o joelho à frente mantendo o calcanhar totalmente apoiado no chão.'},
      {name:'Elevação de ponta do pé',time:45,detail:'Mantenha os calcanhares apoiados e eleve a parte da frente dos pés de forma controlada.'},
      {name:'Elevação de panturrilha',time:50,detail:'Eleve os calcanhares, sustente brevemente e retorne lentamente ao chão.'},
      {name:'Transferência de peso',time:45,detail:'Desloque o peso de um pé para o outro com controle, mantendo estabilidade dos tornozelos.'}
    ]
  },
  full:{
    title:'Corpo Inteiro',
...
const MOBILITY_HD={
  ...
  'Elevação de ponta do pé':['assets/mobility/tornozelos/ponta-pe-a.webp','assets/mobility/tornozelos/ponta-pe-b.webp'],
  'Elevação de panturrilha':['assets/mobility/tornozelos/panturrilha-a.webp','assets/mobility/tornozelos/panturrilha-b.webp'],
  'Transferência de peso':['assets/mobility/tornozelos/transferencia-a.webp','assets/mobility/tornozelos/transferencia-b.webp'],
  'Flexão e extensão de joelho':['assets/mobility/joelhos/flexao-extensao-a.webp','assets/mobility/joelhos/flexao-extensao-b.webp'],
