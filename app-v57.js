...
const MOBILITY_ROUTINES={
  shoulders:{
    title:'Ombros',
    icon:'◒',
    subtitle:'Mobilidade escapular e amplitude dos ombros',
    duration:'6 min',
    steps:[
      {name:'Círculos de ombro',time:40,detail:'Faça círculos amplos para trás, mantendo o tronco estável.'},
      {name:'Deslizamento na parede',time:50,detail:'Costas apoiadas; deslize os braços para cima sem forçar.'},
      {name:'Rotação torácica em quatro apoios',time:50,detail:'Leve uma mão atrás da cabeça e gire o tórax com controle.'},
      {name:'Passagem de braços',time:50,detail:'Com cabo leve, toalha ou elástico, passe os braços acima da cabeça dentro de uma amplitude confortável.'},
      {name:'Alongamento peitoral na parede',time:45,detail:'Antebraço apoiado e rotação suave do tronco.'},
      {name:'Respiração e soltura escapular',time:45,detail:'Respire lentamente e relaxe ombros e pescoço.'}
    ]
  },
  spine:{
    title:'Coluna & Lombar',
    ...
    duration:'7 min',
    steps:[
      {name:'Gato-vaca',time:50,detail:'Alterne flexão e extensão da coluna de forma lenta e confortável.'},
      {name:'Rotação torácica',time:50,detail:'Em quatro apoios, gire o tronco sem movimentar excessivamente o quadril.'},
      {name:'Postura da criança com alcance lateral',time:50,detail:'Sente o quadril em direção aos calcanhares e alcance as mãos para cada lado.'},
      {name:'Joelhos ao peito',time:45,detail:'Deitado, aproxime os joelhos do peito sem puxar com força.'},
      {name:'Rotação lombar deitado',time:50,detail:'Joelhos flexionados, mova-os suavemente de um lado ao outro.'},
      {name:'Bird-dog controlado',time:60,detail:'Alterne braço e perna opostos, mantendo o tronco firme.'}
    ]
  },
  hips:{
    title:'Quadril',
  ...
  knees:{
    title:'Joelhos',
    icon:'⌁',
    subtitle:'Preparação de joelhos e cadeia inferior',
    duration:'5 min',
    steps:[
      {name:'Flexão e extensão de joelho',time:40,detail:'Movimento leve e controlado, sem carga.'},
      {name:'Agachamento parcial controlado',time:50,detail:'Desça apenas até onde houver conforto e bom alinhamento.'},
      {name:'Passada reversa curta',time:50,detail:'Dê um passo para trás e retorne, mantendo o joelho alinhado.'},
      {name:'Elevação de panturrilha',time:50,detail:'Suba e desça lentamente, usando apoio se necessário.'},
      {name:'Isometria de parede leve',time:35,detail:'Mantenha uma posição confortável, sem buscar fadiga máxima.'}
    ]
  },
  ankles:{
    title:'Tornozelos',
    icon:'↗',
    subtitle:'Dorsiflexão, estabilidade e mobilidade do tornozelo',
    duration:'5 min',
    steps:[
      {name:'Círculos de tornozelo',time:40,detail:'Faça círculos lentos em ambas as direções.'},
      {name:'Joelho à parede',time:50,detail:'Leve o joelho em direção à parede mantendo o calcanhar no chão.'},
      {name:'Elevação de ponta do pé',time:45,detail:'Eleve a ponta dos pés mantendo os calcanhares apoiados.'},
      {name:'Elevação de panturrilha',time:50,detail:'Suba devagar e desça controlando o movimento.'},
      {name:'Transferência de peso',time:45,detail:'Desloque o peso entre os pés com controle e estabilidade.'}
    ]
  },
  full:{
    title:'Corpo Inteiro',
    icon:'✦',
    subtitle:'Rotina rápida antes ou depois do treino',
    duration:'8 min',
    steps:[
      {name:'Respiração + mobilidade cervical',time:40,detail:'Respiração lenta e movimentos suaves do pescoço.'},
      {name:'Círculos de ombro',time:40,detail:'Movimente os ombros em amplitude confortável.'},
      {name:'Gato-vaca',time:50,detail:'Mobilize toda a coluna lentamente.'},
      {name:'Rotação torácica',time:50,detail:'Gire o tronco com controle em quatro apoios.'},
      {name:'90/90 de quadril',time:60,detail:'Alterne os lados com movimento controlado.'},
      {name:'Agachamento profundo assistido',time:50,detail:'Use um apoio e mantenha postura confortável.'},
      {name:'Joelho à parede',time:50,detail:'Mobilize o tornozelo mantendo o calcanhar no chão.'},
      {name:'Respiração final',time:40,detail:'Respire fundo, relaxando ombros e tronco.'}
    ]
  }
};
...
function mobilityAnimationSvg(name=''){
  ...
  const common=`
    <svg class="mobility-svg mobility-${type}" viewBox="0 0 320 220" role="img" aria-label="Animação auxiliar de ${name}">
      <defs>
        <filter id="mobGlow"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
      </defs>
      <circle class="mob-head" cx="160" cy="45" r="18"/>
      <line class="mob-body" x1="160" y1="63" x2="160" y2="126"/>
      <line class="mob-limb mob-arm-l" x1="160" y1="78" x2="115" y2="104"/>
      <line class="mob-limb mob-arm-r" x1="160" y1="78" x2="205" y2="104"/>
      <line class="mob-limb mob-leg-l" x1="160" y1="126" x2="132" y2="184"/>
      <line class="mob-limb mob-leg-r" x1="160" y1="126" x2="188" y2="184"/>
      <path class="mob-arrow mob-arrow-a" d="M72 92 Q60 48 100 30"/>
      <path class="mob-arrow mob-arrow-b" d="M248 92 Q260 48 220 30"/>
      <circle class="mob-focus mob-focus-a" cx="160" cy="80" r="34"/>
      <text class="mob-svg-label" x="160" y="210" text-anchor="middle">${name}</text>
    </svg>`;
  return common;
}
...
function renderMobilityRoutine(){
  ...
  box.innerHTML=`
    <div class="mobility-routine-head">
      <button class="mobility-mini-back" onclick="renderStretch()">← Rotinas</button>
    ...
    <div class="mobility-step-card">
      ...
      <div class="mobility-animation-card">
        ...
        ${mobilityAnimationSvg(step.name)}
        <div class="mobility-animation-hint">Observe o sentido das setas e execute de forma lenta e controlada.</div>
      </div>
...
function mobilityToggle(){
  const r=MOBILITY_ROUTINES[mobilityRoutineKey];
  if(!r)return;
  if(mobilityRunning){mobilityStopTick();renderMobilityRoutine();return}
...
function mobilityNext(){
  const r=MOBILITY_ROUTINES[mobilityRoutineKey]; if(!r)return;
  mobilityStopTick();
  if(mobilityStep>=r.steps.length-1){renderMobilityComplete();return}
  mobilityStep++;
  mobilityRemaining=r.steps[mobilityStep].time;
  renderMobilityRoutine();
}
function renderMobilityComplete(){
  ...
  box.innerHTML=`
    <div class="mobility-complete">
      ...
      <button class="primary" onclick="renderStretch()">VOLTAR ÀS ROTINAS</button>
    </div>`;
}
...
function v55ValidWorkout(w){return w?.excludedFromStats!==true&&Number(w?.exercisesDone||0)>=3&&Number(w?.sets||0)>=6}
function v55Stats(){
 ...
 return {all:all.length,month:month.length,valid:month.filter(v55ValidWorkout).length,
...
function openV55Profile(){
 ...
 <div class="card"><h3>CONSTÂNCIA DO MÊS</h3><div class="v55-big">${s.valid} <small>treinos válidos</small></div><p>Para o ranking, contam treinos com pelo menos 3 exercícios e 6 séries.</p></div>
...
async function v55LoadRanking(){
 ...
 box.innerHTML=`<div class="v55-rank-title"><small>2ª CIA / 4º BBM</small><h2>Ranking de Constância</h2><p>${new Date().toLocaleDateString('pt-BR',{month:'long',year:'numeric'})}</p></div>`+
 ...
 '<p class="v55-note">O ranking mede constância, não força. Cargas individuais não são exibidas.</p>';
