...
localStorage.setItem('t2_app_version','v65.1');
...
async function v55LoadRanking(){
 ...
 <div class="card v55-rank-explain"><h3>Como funciona a pontuação?</h3><p><b>Cada treino válido soma 1 ponto de constância.</b> Para ser válido, o treino precisa ter pelo menos <b>3 exercícios e 6 séries registradas</b>. A posição no ranking é definida pela quantidade de treinos válidos no mês; carga e peso levantado não aumentam a pontuação.</p></div>`+
