...
function saveCardioWorkout(){
  ...
  const record={
    ...
    schemaVersion:6737,excludedFromStats:false,workoutType:'cardio',rankingCategory:'cardio',muscleGroups:['Cardio'],cardioMachine:machine,
...
function saveFreeWorkout(){
  ...
  const record={
    ...
    exercisesPlanned:0,exercisesDone:0,sets:0,reps:0,volume:0,byExercise:[],
    schemaVersion:6737,excludedFromStats:false,workoutType:'free',muscleGroups:groups,
