...
function showView(id){
  ...
  // V67.26 — garante que a tela de origem também exista no histórico.
  // Isso resolve o primeiro "Voltar" do Android mesmo quando a navegação
  // acontece logo após o login ou antes do carregamento completo do PWA.
...
function appBack(fallbackView='home', fallbackAction=null){
  try{
    ...
    if(st?.t2App && window.history.length>1){
      window.history.back();
      return;
    }
  }catch(e){}
