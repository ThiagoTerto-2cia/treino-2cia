...
const MOBILITY_ROUTINES={
  shoulders:{
    ...
    duration:'7 min',
    steps:[
      {name:'Círculos de ombro',time:40,detail:'Faça círculos amplos e lentos, mantendo o tronco estável e o abdômen firme.'},
      {name:'Elevação e retração escapular',time:40,detail:'Eleve e recue as escápulas de forma controlada, sem projetar a cabeça para frente.'},
      {name:'Mobilidade com bastão',time:50,detail:'Com pegada confortável, conduza o bastão acima da cabeça até o limite sem dor.'},
      {name:'Rotação externa de ombro',time:40,detail:'Mantenha os cotovelos próximos ao corpo e gire os antebraços para fora lentamente.'},
      {name:'Rotação interna de ombro',time:40,detail:'Gire os antebraços para dentro com controle, sem compensar com o tronco.'},
      {name:'Alongamento peitoral na parede',time:40,detail:'Apoie a mão ou antebraço e gire suavemente o tronco para abrir o peitoral.'},
      {name:'Deslizamento na parede',time:50,detail:'Mantenha costas e braços próximos à parede enquanto desliza os braços para cima e para baixo.'}
    ]
  },
  spine:{
    title:'Coluna & Lombar',
...
const MOBILITY_HD={
  ...
  'Elevação e retração escapular':['assets/mobility/ombros/escapular-a.webp','assets/mobility/ombros/escapular-b.webp'],
  'Mobilidade com bastão':['assets/mobility/ombros/bastao-a.webp','assets/mobility/ombros/bastao-b.webp'],
  'Rotação externa de ombro':['assets/mobility/ombros/rotacao-externa-a.webp','assets/mobility/ombros/rotacao-externa-b.webp'],
  'Rotação interna de ombro':['assets/mobility/ombros/rotacao-interna-a.webp','assets/mobility/ombros/rotacao-interna-b.webp'],
  'Alongamento peitoral na parede':['assets/mobility/ombros/peitoral-a.webp','assets/mobility/ombros/peitoral-b.webp'],
  'Deslizamento na parede':['assets/mobility/ombros/wall-slide-a.webp','assets/mobility/ombros/wall-slide-b.webp'],
  '90/90 de quadril':['assets/mobility/quadril/90-90-a.webp','assets/mobility/quadril/90-90-b.webp'],
