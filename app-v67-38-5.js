...
async function v67383DeleteFeedDescriptor(desc,queueOnFail=true){
  ...
  try{
    // V67.38.5: uma única RPC faz a exclusão por atividade_id, JSON interno,
...
async function v67384ReconcileMyFeed(){
  ...
  try{
    // V67.38.5: se o Histórico estiver vazio, o Feed próprio também deve ficar vazio.
...
function v6738CompactActivity(w){
  ...
  // V67.38.5: a localização vira parte da própria atividade no momento em que ela
...
async function v67382RefreshFeed(button){
  ...
  try{
    v6738FeedLastLoad=0;
    // V67.38.5: o botão atualizar também reconcilia as publicações deste militar
