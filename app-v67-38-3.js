...
/* ===== V67.38.3 — FEED ESPORTIVO DA 2ª CIA ===== */
...
async function v67383DeleteFeedDescriptor(desc,queueOnFail=true){
  ...
  try{
    if(d.activityId){
      const r=await cloudRpc('feed_excluir_atividade_id_v67383',{p_token_militar:cloudSession.token,p_atividade_id:d.activityId});
      if(r?.excluido===true||Number(r?.quantidade)>0)return true;
    }
    await cloudRpc('feed_excluir_atividade_v67383',{
